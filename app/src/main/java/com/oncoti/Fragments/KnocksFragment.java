 ...
 */
public class KnocksFragment extends Fragment{
    View v;
    private RecyclerView KncocksGridView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v =inflater.inflate(R.layout.knocks_tab,container,false);
    ...
    private void initUI() {
        prodListProgLay = (LinearLayout) v.findViewById(R.id.kncokslist_progress_lay);
        noProdTV = (TextView) v.findViewById(R.id.knocklist_noprod_tv);
        prodlistProgPB = (ProgressBar) v.findViewById(R.id.knocklist_pb);
        KncocksGridView = (RecyclerView) v.findViewById(R.id.knocks_grid);
        KncocksGridView.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
...
//                        String uploadTime = product.get("createdAt").toString();
    ...
    private void fillProdductList(ArrayList<ProductModel> productModels) {
        ...
        if (productModels.size() != 0) {
            ...
            KnocksStaggGridAdapter adapter = new KnocksStaggGridAdapter(getActivity(), productModels);
            KncocksGridView.setAdapter(adapter);
            SpacesItemDecoration decoration = new SpacesItemDecoration(16);
            KncocksGridView.addItemDecoration(decoration);
...
//            });
        ...
        productModels.add(new ProductModel(iBitmaps, ownerImage, userUsername, null, category, prodName, description, price, (ArrayList<String>) tags, likesCounter, 12));
